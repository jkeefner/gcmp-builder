    ...
    fields: [
      {
        ...
        label: 'Mine Name',
        type: 'text',
        placeholder: 'e.g. Thompson Creek Mine',
        required: true,
      ...
      },
      {
        ...
        type: 'text',
        placeholder: 'e.g. SSR Mining Inc.',
        required: true,
        sectionRef: '1.1',
      },
      {
        ...
        type: 'text',
        placeholder: 'e.g. Centerra Gold Inc.',
        sectionRef: '1.1',
      },
      {
        key: 'site_location',
        ...
        type: 'text',
        placeholder: 'e.g. Custer County, Idaho, USA',
        required: true,
        sectionRef: '3.1',
      },
      {
  ...
  // ── 2. DOCUMENT CONTROL ────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'text',
        placeholder: 'e.g. P.E. #12345, Idaho',
        sectionRef: '1.1',
      },
      {
  ...
  // ── 3. KEY PERSONNEL ───────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'text',
        placeholder: 'e.g. P.E. #54321, State of Idaho',
        required: true,
        sectionRef: '4.1, 4.2',
      },
      {
