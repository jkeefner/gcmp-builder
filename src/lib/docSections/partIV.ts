...
import {
  ...
  sectionHeader, guidanceBox, actionBox, metaTable, narrativeBlock,
  ...
  return [
    ...
    ...(isSkipped('7.1', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['7.1']?.narrative ?? ''),
    ...
    ...(isSkipped('7.2', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['7.2']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('7.3', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['7.3']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('7.4', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['7.4']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('7.5', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['7.5']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('8.1', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['8.1']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('8.2', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['8.2']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('8.3', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['8.3']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('8.4', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['8.4']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('8.5', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['8.5']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('8.6', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['8.6']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('8.7', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['8.7']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('8.8', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['8.8']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('8.9', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['8.9']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('8.10', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['8.10']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('9.1', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['9.1']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('9.2', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['9.2']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('9.3', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['9.3']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('10.1', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['10.1']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('10.2', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['10.2']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('10.3', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['10.3']?.narrative ?? ''),
    ...
    ...(isSkipped('10.4', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['10.4']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('10.5', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['10.5']?.narrative ?? ''),
    ...
    ...(isSkipped('11.1', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['11.1']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('11.2', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['11.2']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
    ...
    ...(isSkipped('11.3', ss)
      ...
      : [
          ...
          ...narrativeBlock(ss['11.3']?.narrative ?? ''),
          guidanceBox('Why This Section Matters', [
